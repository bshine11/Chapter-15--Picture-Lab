	...
	public void upsideDown() {
		...
		for (int col = 0; col < width; col++) {
			for (int row = 0; row < midIndex; row++) {
				leftPixel = pixels[row][col];
				rightPixel = pixels[lastIndex - row][col];
				Color temp = rightPixel.getColor();
				rightPixel.setColor(leftPixel.getColor());
				leftPixel.setColor(temp);
			}
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	// the left half is the same as the right half
...
//////////////////////////////////////////////////////////////////////////////////////////////////      
	...
	// REQUIRED FOR 90-POINTS
	// line of mirror is going diagonal from top left corner to bottom right
	// corner
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	// repairs the roof of the temple and keeps the bottom, use top mirror
